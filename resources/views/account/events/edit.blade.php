...
{{--                @method('PUT')--}}
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" value="{{$item->event_name}}" id="event_name"
                               name="event_name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control " value="{{$item->start_date}}" id="start_date"
                               name="start_date">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control " value="{{$item->end_date}}" id="end_date"
                               name="end_date">
                    </div>
                </div>
