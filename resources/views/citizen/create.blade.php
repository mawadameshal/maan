                        ...
                        <form method="POST" id="form1" class="form-horizontal" action="/citizen/savenew">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{($errors->first('mobile') ? " form-error" : "")}}"  type="tel" maxlength="10" onchange="phonenumber($('#mobile').val(),1)" value="{{old("mobile")}}" id="mobile" name="mobile">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select
                                        ...
                                        <option value="الشمال" {{old('governorate')=='الشمال'?"selected":""}}>الشمال
                                        </option>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control {{($errors->first('city') ? " form-error" : "")}}"
                                           type="text" value="{{old("city")}}" id="city" name="city" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input name="project_name" value="{{$project_code." ".$project_name}}" type="text"
                                           readonly class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <form id="form2" action="/forms/formsavenew" method="POST"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="title"
                                           class="col-sm-4 col-form-label">موضوع {{$form_type->find($type)->name}}</label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="content"
                                           class="col-sm-4 col-form-label">محتوى {{$form_type->find($type)->name}}</label>
                                    <textarea id="content"
